...
const (
	...
	LeanFormatEnabled = "leanFormatEnabled"
)
...
func NewApplicationProvider(capabilities map[string]*cb.Capability) *ApplicationProvider {
	...
	_, ap.leanFormatEnabled = capabilities[LeanFormatEnabled]
	return ap
}
...
func (ap *ApplicationProvider) LeanFormatEnabled() bool {
	return ap.leanFormatEnabled
}
